...
2. ./auto_labeler.py -i input_comics_episodes_dir -o output_tagged --lang_hint=ko
...
def get_args_parser():
    ...
    parser.add_argument('-i', '--meme_dir', type=str, required=True, help='Folder directory of input meme folders.')
    parser.add_argument('-o', '--output_dir', type=str, required=True, help='Folder directory of output xml folders.')
