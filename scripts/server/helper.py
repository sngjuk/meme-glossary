...
def get_args_parser():
    ...
    parser.add_argument('-i','--image_dir', type=str, required=True, help='Directory of meme. e.g ./3_manual_filtered_cut/')
    parser.add_argument('-x','--xml_dir', type=str, required=True, help='Directory of xml. e.g ./4_label_xml/')
    parser.add_argument('-v','--vec_path', type=str, required=True, help='Path of a .vec file. e.g ./5_test_meme_voca.vec')
